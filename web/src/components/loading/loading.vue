...
<div id="loading">
  ...
  </svg> <svg version="1.1" id="cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enable-background="new 0 0 10 10" xml:space="preserve">
...
#loading .drop:nth-child(7) {
	-webkit-animation-delay: -900ms;
	animation-delay: -900ms;
}

#loading .drop:nth-child(8) {
	-webkit-animation-delay: -1050ms;
	animation-delay: -1050ms;
}

#loading .drop:nth-child(9) {
	-webkit-animation-delay: -1130ms;
	animation-delay: -1130ms;
}

#loading .drop:nth-child(10) {
